...
router.post("/updatePassword", [
  ...
  try {
    ...
    var salt = await bcrypt.genSalt(10); // this is the salt 
    var securePassword = await bcrypt.hash(password, salt); // creating a secure password, using hash function of bcrypt and passing the plain password and genaredt salt
    ...
    res.status(200).json({ success, authToken, message: "Password changed successfully" }); // sending the authToken, when it found successfully
